...
public class ChessGameViewer extends JFrame {
	...
	/**
	 * 
	 * chessMain is the start of the whole program, it creates a chess, and a
	 * frame to hold everything in it.
	 * 
	 * @author zhangq2
	 *
	 */
	...
	private static void intializeRules() {
		...
		rules.put("king", "The king moves one square in any direction. You always want to protect your king.\n"
		...
		rules.put("bishop", "The bishop can move any number of squares diagonally, without going over any pieces.");
		rules.put("knight",
