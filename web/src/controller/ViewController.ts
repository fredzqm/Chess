...
namespace controller {
    ...
    import InvalidMoveException = model.InvalidMoveException;

    import Move = model.Move;

    import Pawn = model.Pawn;

    import Piece = model.Piece;
        ...
        public makeMove(view : IChessViewer, moveCommand : string) : boolean {
            ...
            try {
                ...
                case model.InvalidMoveException.Type.invalidFormat:
                    ...
                    break;
                case model.InvalidMoveException.Type.ambiguousMove:
                    view.printOut("Fail to guess move: There is ambiguity, multiple possible moves.");
                    break;
                case model.InvalidMoveException.Type.castleNotAllowed:
                    view.printOut("You cannot do castling, please check the rules for castling.");
                    break;
                case model.InvalidMoveException.Type.impossibleMove:
                    view.printOut("This is not a possible move.");
                    break;
                case model.InvalidMoveException.Type.incorrectPiece:
...
controller.ViewController.rules_$LI$();
